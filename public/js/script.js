    ...
    Vue.component("modal", {
        ...
        methods: {
            sendCloseEvent: function(e) {
                if (
                    e.target == document.getElementById("modal-default-button")
                ) {
                    this.$emit("close");
                } else {
                    return;
            ...
            id: function() {
                ...
                axios
                    ...
                    .then(function(results) {
                        ...
                        self.description = results.data[0].description;
                        self.username = results.data[0].username;
                        self.uploadTime = results.data[0].created_at.slice(
                            0,
                            16
                        );
                    });
    ...
    new Vue({
        ...
        data: {
            ...
            form: {
                ...
                currentImage: location.hash.slice[1] || 0
        },
